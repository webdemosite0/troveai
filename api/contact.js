...
const SUPABASE_KEY = process.env.SUPABASE_PUBLISHABLE_KEY || 'sb_publishable_L654grsHppTWaZjmL6HlDA_8uUxgMXb';
...
export default async function handler(req, res) {
  ...
  if (req.method === 'GET') return res.status(200).json({ ok: true, provider: 'supabase', configured: Boolean(SUPABASE_URL && SUPABASE_KEY) });
